window.initGeneralScripts = function() {
  if (initGeneralScripts.done) return; // Evita duplicats
  initGeneralScripts.done = true;
...
/*
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    if (!window.Vue) window.initGeneralScripts();
