...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if(idiomaBtn&&menuIdioma){ //definimos condicional para evitar error en pagina dinámica
  ...
  if(navBtn&&menuNav){ //definimos condicional para evitar error en pagina dinámica
